...
| expire_time   | uint   | 否            | 3天      | 1.消息离线存储时间（单位为秒），最长存储时间3天<br>2.若设置为0，则取默认值（3天）<br>3.若设置0&ltexpire_time&lt180，则系统会重置为180s<br>4.若设置离线存储时间>=180s，按实际设置时间存储，最长72小时<br>5.建议取值区间[180, 86400x3] |
